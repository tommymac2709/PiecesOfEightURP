...
public class Targeter : MonoBehaviour
{
    ...
    public bool SelectTarget()
    {
        ...
        CurrentTarget = closestTarget;
        currentTargetIndex = targets.IndexOf(CurrentTarget); // Set the index for cycling
        cinemachineTargetGroup.AddMember(CurrentTarget.transform, 1, 2);
        return true;
    }
    ...
    public void CycleTarget()
    {
        ...
        // Increment the target index and wrap it around if it exceeds the list bounds
    ...
    public void CancelTargeting()
    {
        ...
        cinemachineTargetGroup.RemoveMember(CurrentTarget.transform);
        CurrentTarget = null;
        currentTargetIndex = -1; // Reset the index when targeting is cancelled
    }
